(function(U, r, L, q, f, g, be) {
    ...
    function Fe() {
        try {
            return f.storage[A]?.showEmbed !== !1
        } catch {
            return !0
        }
    }
    ...
    function st() {
        ...
        const {ScrollView: e, View: t, Text: n, TextInput: i, TouchableOpacity: a, StyleSheet: o, KeyboardAvoidingView: l, Platform: p, Switch: $} = r.ReactNative
        ...
        return r.React.createElement(l, {
            ...
            style: [s.button, b && s.buttonDisabled],
            onPress: mt,
            disabled: b
        }, r.React.createElement(n, {
            style: s.buttonText
            ...
            style: s.buttonText
        }, "Replay cached local messages")), r.React.createElement(a, {
            style: [s.button, s.buttonDanger],
            onPress: ht
        }, r.React.createElement(n, {
            style: s.buttonText
        }, "Clear cached local messages")), r.React.createElement(n, {
            style: s.helper
        }, "Local messages stay on your device for testing embeds.")), r.React.createElement(t, {
            style: [s.section, s.messageSection]
        }, r.React.createElement(n, {
            style: s.sectionTitle
        }, "Cached local messages"), he.length ? he.map(function(c) {
            ...
            }, "Replay")), r.React.createElement(a, {
